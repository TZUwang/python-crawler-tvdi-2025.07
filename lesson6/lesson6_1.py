import asyncio
from crawl4ai import AsyncWebCrawler, BrowserConfig, CrawlerRunConfig, CacheMode, JsonCssExtractionStrategy  #BrowserConfig是用來設定瀏覽器的配置
...
async def main():
    ...
    stock_schema = {
        ...
        "fields": [
            ...
            {
                "name": "即時價格",
                "selector":"div.quotes-info div.deal", # 假設即時價格在這個選擇器下
                "type": "text"
